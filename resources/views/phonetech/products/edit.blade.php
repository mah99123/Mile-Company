...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <a href="{{ route('phonetech.products.show', $product) }}" class="btn btn-outline-secondary">
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('phonetech.products.update', $product) }}">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                            ...
                            <option value="Phone" {{ old('category', $product->category) == 'Phone' ? 'selected' : '' }}>هاتف</option>
                            <option value="Accessory" {{ old('category', $product->category) == 'Accessory' ? 'selected' : '' }}>إكسسوار</option>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('quantity_in_stock') is-invalid @enderror" 
                               id="quantity_in_stock" name="quantity_in_stock" value="{{ old('quantity_in_stock', $product->quantity_in_stock) }}" required>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('reorder_threshold') is-invalid @enderror" 
                               id="reorder_threshold" name="reorder_threshold" value="{{ old('reorder_threshold', $product->reorder_threshold) }}" required>
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('phonetech.products.show', $product) }}" class="btn btn-secondary">إلغاء</a>
