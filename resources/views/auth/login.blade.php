...
<head>
    ...
    <title>تسجيل الدخول - نظام إدارة المنصات المتعددة</title>
    ...
    <style>
        * {
        ...
        .animated-bg {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(45deg, var(--primary-color), var(--secondary-color), var(--accent-gold), var(--info-color));
        ...
        .particle:nth-child(5) { width: 50px; height: 50px; top: 70%; left: 60%; animation-delay: 3s; }
...
<body>
    ...
    <div class="login-container">
        ...
        <p class="login-subtitle">مرحباً بك في نظام إدارة المنصات المتعددة</p>
